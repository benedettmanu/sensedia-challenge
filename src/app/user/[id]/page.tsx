...
export default function UserProfile() {
  ...
  if (loading) {
    return (
      <div className="min-h-screen w-[870px] mx-auto mt-[153px]">
  ...
  if (error) {
    return (
      <div className="min-h-screen w-[870px] mx-auto mt-[153px] h-full flex flex-col items-center">
        <h1 className="text-[24px] text-[var(--user-gray)] font-bold mb-[25px]">
          {error}
        </h1>
        <p className="text-[var(--gray)] mb-6">
          O perfil que você está procurando não foi encontrado ou não está
          disponível.
        </p>
        <Link
          href="/user"
      ...
      <div className="w-full border border-[var(--table-gray)] rounded-[10px] p-8">
        ...
        <div className="mt-8 grid grid-cols-2 gap-4">
          <div className="border border-[var(--table-gray)] rounded-md p-4">
            <h3 className="text-[16px] font-bold text-[var(--color-primary)] mb-2">
              Estatísticas
            </h3>
            <div className="flex justify-between">
              <div>
                <p className="text-[var(--gray)]">Posts</p>
                <p className="text-[20px] font-bold text-[var(--user-gray)]">
                  {user.posts_count || 0}
                </p>
              </div>
              <div>
