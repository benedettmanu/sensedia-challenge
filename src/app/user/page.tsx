...
export default function UserListPage() {
    ...
    return (
        <div>
            <div className="w-[870px] mx-auto flex flex-end items-center mt-[153px]">
                <Link
                    href="/users/new"
            ...
            {showNotification && (
                <div
                    className={`fixed bottom-4 right-4 px-6 py-3 rounded-lg shadow-lg transition-all ${type === 'success' ? 'bg-green-500' : 'bg-red-500'
                        } text-white z-50`}
                >
                    {notification}
                </div>
