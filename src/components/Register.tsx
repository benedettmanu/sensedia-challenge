...
const Register = ({ redirectPath }: RegisterProps) => {
        ...
        try {
            ...
            if (!response.ok) {
                ...
                try {
                    ...
                    errorMessage = errorData.error || `Falha ao criar usuário (${response.status})`;
                } catch (parseError) {
    ...
    return (
        <div className="w-[875px] h-auto mx-auto mb-[20px]">
            ...
            <form onSubmit={handleSubmit} className="w-[870px] h-auto border border-[var(--table-gray)] pt-[36px] px-[20px] rounded-[10px]">
